...
While testing the api I thought about downloading the apk version of this app to see if there were other endpoints that I could test further. After decompiling the apk,
I noticed an endpoint that changes the email of the user, and I noticed that this endpoint is open to <span style="color:red">***CSRF***</span> vulnerability, but The
